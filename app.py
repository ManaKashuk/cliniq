...
def main():
    ...
    st.markdown(
        ...
        <style>
          ...
          .hero p  { font-size:1.05rem; color:#333; max-width:1200px; margin:.35rem 0 0 0; }
    ...
    st.markdown(
        ...
        <div class="hero">
          ...
          <p>💡 Smart Assistant for Clinical Trial SOP Navigation</p>
...
".join(pages)))
    ...
    if st.session_state["chat"]:
        ...
        # --- NEW: Download chat history (unchanged snippet) ---
        chat_text = ""
