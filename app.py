...
def main():
    ...
    st.markdown(
        ...
        <style>
          ...
          .hero p  { font-size:1.5rem; color:#333; max-width:2000px; margin:.25rem 0 0 0; }
    ...
    st.markdown(
        ...
        <div class="hero-wrap">
            ...
            <div class="hero">
                ...
                <p>I am trained on institutional Standard Operating Procedures (SOPs), helping research teams navigate essential documentation, regulatory requirements, and Good Clinical Practice (GCP) standards with clarity and confidence.</p>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
